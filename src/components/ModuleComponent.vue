    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b class="text-success"><marquee behavior="" direction="">ຍິນດີຕອນຮັບເຂົ້າສູ່ລະບົບ</marquee></b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><router-link to="/dashboard" href="#">ໜ້າຫຼັກ</router-link></li>
              <li class="breadcrumb-item active text-success">ໂມດູລ</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        <div class="row mb-2">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-6">
              <h3 class="text-center"><br>ຟອມໂມດູລ</h3>
              ...
              <form @submit.prevent="CreateModule">
                <div class="card-body">
                  <div class="row">
                    ...
                    <input type="text" class="form-control" required v-model="modulename" id="exampleInputEmail1" placeholder="ກະລູນາປ້ອນຊື່">
                  </div>
                ...
                <div class="card-footer">
                  <button type="reset" class="btn btn-danger"><i class="fas fa-times mr-1"></i>ຍົກເລີກ</button>&nbsp;&nbsp;<button type="submit" class="btn btn-success"><i class="fas fa-print mr-1"></i>ບັນທືກ</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
              ...
              <tbody>
                ...
                <tr v-else v-for="modules in modules_s" :key="modules.id">
                  ...
                  <td>
                    ...
                    <button @click="ConfirmDelete(modules.id)" class="btn btn-success"><i class=" fas fa-times"></i></button>
                  </td>
                </tr>
              </tbody>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header bg-info">
              <h4 class="modal-title">ຟອມແກ້ໄຂຂໍ້ມູນ ໂມດູລ</h4>
            ...
            <form enctype="multipart/form-data" @submit.prevent="UpdateModule">
              ...
              <div class="row">
                <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊື່ໂມດູລ<span class="text-danger">*</span> </label>
                    <input type="text" class="form-control" required v-model="updatemodulename" id="exampleInputEmail1" placeholder="ກະລູນາປ້ອນຊື່">
                  </div>
                  
              </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fas fa-times mr-1"></i>ຍົກເລີກ</button>
    ...
    async DeleteModule(Module_ID){
      ...
      async ConfirmDelete(Module_ID){
        Swal.fire({
          ...
          text: 'ທ່ານ ແນ່ໃຂບໍ່ ທີ່ຈະລືບລະຫັດທີ່: ' + Module_ID,
          icon: 'warning',
