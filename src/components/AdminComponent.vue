    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-6">
              <h3 class="text-center"><br>ຟອມແອັດມິນ</h3>
              ...
              <form @submit.prevent="CreateAdmin">
                <div class="card-body">
                  <div class="row">
                    ...
                    <input type="text" class="form-control" required v-model="username" id="exampleInputEmail1" placeholder="ກະລູນາປ້ອນຊື່">
                  </div>
                  <div class="form-group ml-5 mb-3">
                    <label for="exampleInputEmail1">ອີເມວ<span class="text-danger">*</span></label>
                    <input type="email" class="form-control" required v-model="email" id="exampleInputEmail1" placeholder="email@gmail.com">
                  </div>
                  <div class="form-group ml-5 mb-3">
                    <label for="exampleInputPassword1">ລະຫັດຜ່ານ:<span class="text-danger">*</span></label>
                    <input type="password" class="form-control" required v-model="password" id="exampleInputPassword1" placeholder="*********">
                  </div> 
                  <div class="form-group ml-5 mb-3">
                    <label for="exampleInputPassword1">ເບີໂທ:<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" required v-model="phone" id="exampleInputPassword1" placeholder="020xxxxxxxx">
                  </div>
                  </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  <button type="reset" class="btn btn-danger"><i class="fas fa-times mr-1"></i>ຍົກເລີກ</button>&nbsp;&nbsp;<button type="submit" class="btn btn-primary"><i class="fas fa-print mr-1"></i>ບັນທືກ</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
              ...
              <tbody>
                <tr v-for="admin in admins" :key="admin.id">
                  ...
                  <td>
                    ...
                    <button @click="ConfirmDelete(admin.id)" class="btn btn-danger"><i class=" fas fa-times"></i></button>
                  </td>
                </tr>
              </tbody>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header bg-info">
              <h4 class="modal-title">ຟອມແກ້ໄຂຂໍ້ມູນ ແອັດມິນ</h4>
            ...
            <form enctype="multipart/form-data" @submit.prevent="UpdateAdmin">
              ...
              <div class="row">
                <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ຊື່<span class="text-danger">*</span> </label>
                    <input type="text" class="form-control" required v-model="updateusername" id="exampleInputEmail1" placeholder="ກະລູນາປ້ອນຊື່">
                  </div>
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputEmail1">ອີເມວ<span class="text-danger">*</span></label>
                  ...
                  <div class="form-group ml-3 mb-3">
                    <label for="exampleInputPassword1">ເບີໂທ:<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" required v-model="updatephone" id="exampleInputPassword1" placeholder="020xxxxxxxx">
                  </div>
              </div>
            </div>
    ...
    methods: {
      ...
      async ConfirmDelete(Admin_ID){
        Swal.fire({
          ...
          text: 'ທ່ານ ແນ່ໃຂບໍ່ ທີ່ຈະລືບລະຫັດທີ່: ' + Admin_ID,
          icon: 'warning',
