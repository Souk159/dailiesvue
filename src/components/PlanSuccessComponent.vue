                    ...
                    <div class="col-md-8">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex mb-2">
                                ...
                                <button @click="SearchPlans" class="btn btn-primary ml-2"><i
...
export default {
    ...
    methods: {
        ...
        async ShowPlanSuccess() {
            try {
                const response = await axios.get('https://nodejsbackenddailies-m7t9.onrender.com/api/select-plan-success');
